		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#usermanagementsupplierportal-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"usermanagementsupplierportal-display": {
								"semanticObject": "usermanagementsupplierportal",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=usermanagement.platformregistration",
									"url": sap.ui.require.toUrl("usermanagement/platformregistration")
								}
							}
						}
					}
